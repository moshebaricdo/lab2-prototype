function Button() {
  return (
    <div className="bg-white box-border content-stretch flex gap-[4px] items-center justify-center p-[4px] relative rounded-[4px] shrink-0" data-name="Button">
      ...
      <div className="flex flex-col font-['Font_Awesome_7_Pro:Solid',_sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#292f36] text-[13px] text-center w-[16px]">
        <p className="leading-[1.25]">folder</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="min-h-[32px] relative shrink-0 w-full" data-name="Panel Header">
      <div className="flex flex-row items-center justify-end min-h-inherit overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex gap-[10px] items-center justify-end min-h-inherit pl-[8px] pr-0 py-[8px] relative w-full">
          <Button />
        </div>
      </div>
    </div>
...
function FileManagerV2() {
  return (
    <div className="bg-white content-stretch flex flex-col h-full items-end max-w-[32px] overflow-clip relative shrink-0 w-[32px]" data-name="File Manager V2">
      <PanelHeader />
    </div>
  );
}
...
function LineNumbers() {
  return (
    <div className="content-stretch flex flex-col gap-[2px] items-end overflow-clip relative shrink-0 w-[39px]" data-name="Line Numbers">
      <LineNumber />
      <LineNumber1 />
      <LineNumber2 />
      <LineNumber3 />
...
function Code() {
  return (
    <div className="absolute content-stretch flex gap-[6px] items-center left-[-30px] top-[40px] w-[1038px]" data-name="Code">
      <LineNumbers />
      <CodeWrapper />
    </div>
  );
...
function EditorWrapper() {
  return (
    <div className="basis-0 bg-white box-border content-stretch flex flex-col gap-[8px] grow h-full items-start min-h-px min-w-px px-0 py-[8px] relative shrink-0" data-name="Editor Wrapper">
      <TopRow />
      <Code />
    </div>
  );
...
export default function EditorWrapper1() {
  return (
    <div className="content-stretch flex items-start relative size-full" data-name="Editor Wrapper">
      <FileManagerV2 />
      <EditorWrapper />
    </div>
  );
