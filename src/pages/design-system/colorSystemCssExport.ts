...
export function buildPrimitiveColorsCss(system: ColorSystem): string {
  ...
  return [
    ...
    " Unlike Semantic colors (colors.css) these variables will be equal to the same color value in all themes.",
    " Ideally, these colors should be used for components that are not theme dependent.",
    " */",
    "",
    "/* Generated by the Color Sandbox — do not hand-edit; re-export from the sandbox instead. */",
    "",
    "/* Primitive Colors */",
...
export function buildSemanticColorsCss(system: ColorSystem): string {
  ...
  return [
    ...
    " if you need colors with support of multiple themes, you need to import and use this file.",
    " */",
    "",
    "/* Generated by the Color Sandbox — do not hand-edit; re-export from the sandbox instead. */",
    "",
    ...
    " Semantic color value is specified for every theme, meaning that unlike Primitive Colors, Semantic colors are meant to be different for every theme.",
    " */",
    "",
